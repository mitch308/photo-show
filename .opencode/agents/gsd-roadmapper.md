...
Reference full template: `C:/workspace/photo-show/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/workspace/photo-show/.opencode/get-shit-done/templates/state.md`.
